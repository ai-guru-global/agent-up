...
## 更新摘要
**所做更改**
- 更新了 Prisma Schema 文件路径到新的包结构
- 更新了数据库客户端配置位置
- 增强了实体关系图以反映完整的 625 行 Schema
- 添加了新的技能插件架构和知识库集成详情
- 更新了包管理和依赖关系说明
...
**更新** 现已支持完整的 625 行 Prisma Schema，涵盖 Agent 管理、配置版本控制、反馈系统、发布管理、技能插件架构和知识库集成。

## 项目结构
- 数据库定义位于 packages/db/prisma/schema.prisma，采用 PostgreSQL 作为数据源。
- Prisma Client 在 @agent-up/db 包中通过全局单例导出，避免重复连接。
...
DBPackage["@agent-up/db 包<br/>packages/db/src/client.ts"]
end
subgraph "基础设施"
...
**图表来源**
- [packages/db/prisma/schema.prisma:1-8](file://packages/db/prisma/schema.prisma#L1-L8)
...
- [packages/db/package.json:7-13](file://packages/db/package.json#L7-L13)
...
**章节来源**
- [packages/db/prisma/schema.prisma:10-626](file://packages/db/prisma/schema.prisma#L10-L626)
...
**图表来源**
- [packages/db/prisma/schema.prisma:14-626](file://packages/db/prisma/schema.prisma#L14-L626)
...
**章节来源**
- [packages/db/prisma/schema.prisma:14-55](file://packages/db/prisma/schema.prisma#L14-L55)
- [packages/db/prisma/schema.prisma:38-41](file://packages/db/prisma/schema.prisma#L38-L41)
- [packages/db/prisma/schema.prisma:43-55](file://packages/db/prisma/schema.prisma#L43-L55)
...
**章节来源**
- [packages/db/prisma/schema.prisma:61-97](file://packages/db/prisma/schema.prisma#L61-L97)
- [packages/db/prisma/schema.prisma:103-173](file://packages/db/prisma/schema.prisma#L103-L173)
...
**新增** 技能插件架构支持灵活的 Agent 能力扩展，通过标准化的接口和版本管理机制。
...
**新增** 知识库系统集成提供了完整的文档管理能力，支持多来源内容整合和质量控制。
...
**章节来源**
- [packages/db/prisma/schema.prisma:93-97](file://packages/db/prisma/schema.prisma#L93-97)
- [packages/db/prisma/schema.prisma:133-145](file://packages/db/prisma/schema.prisma#L133-L145)
...
- [packages/db/prisma/schema.prisma:389-409](file://packages/db/prisma/schema.prisma#L389-L409)
- [packages/db/prisma/schema.prisma:500-519](file://packages/db/prisma/schema.prisma#L500-L519)
- [packages/db/prisma/schema.prisma:543-557](file://packages/db/prisma/schema.prisma#L543-L557)
- [packages/db/prisma/schema.prisma:38-41](file://packages/db/prisma/schema.prisma#L38-L41)
...
C["Prisma Client 单例<br/>packages/db/src/client.ts"] --> D["PostgreSQL 16"]
E["Turborepo 脚本<br/>turbo.json + package.json"] --> C
F["Docker Compose<br/>postgres/minio"] --> D
G["@agent-up/db 包<br/>packages/db/package.json"] --> C
```
...
**更新** 新架构通过模块化包设计和完整的实体关系，为复杂的 Agent 管理系统提供了坚实的数据基础。
...
**章节来源**
- [packages/db/prisma/schema.prisma:93-97](file://packages/db/prisma/schema.prisma#L93-L97)
- [packages/db/prisma/schema.prisma:283-292](file://packages/db/prisma/schema.prisma#L283-L292)
- [packages/db/prisma/schema.prisma:507-519](file://packages/db/prisma/schema.prisma#L507-L519)
- [packages/db/prisma/schema.prisma:551-557](file://packages/db/prisma/schema.prisma#L551-L557)
...
- [packages/db/prisma/schema.prisma:205-207](file://packages/db/prisma/schema.prisma#L205-L207)
- [packages/db/prisma/schema.prisma:246-249](file://packages/db/prisma/schema.prisma#L246-L249)
- [packages/db/prisma/schema.prisma:352-354](file://packages/db/prisma/schema.prisma#L352-L354)
