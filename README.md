...
│       │       ├── feedback-service       # 反馈（含状态机校验 + 多渠道工单接入）
...
| **Zod 全量校验** | 29 个 schema 覆盖所有 API 入参 | `lib/schemas.ts` |
...
| `docs/api/api-reference.md` | API 接口完整说明（38 route + 错误码 + LLM 端点细节） |
