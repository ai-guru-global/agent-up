...
| 口径 | 当前值 | 核实命令 |
|------|--------|---------|
| 测试数 | 279（含 2 个 Prisma 冒烟测试，需本地 PG：`docker compose up -d postgres`） | `cd apps/web && pnpm test` |
