      ...
      >
        <Table
          ...
          rows={[
            ...
            [<span><strong>全面测试覆盖</strong></span>, "lib/__tests__ + app/api/__tests__", <span><strong>268 个测试，95.9% 语句覆盖</strong>，含 104 个 API 集成测试</span>],
          ]}
        />
      </Section>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <Card>
            ...
            <p className="mt-2 text-[13px] leading-relaxed text-[var(--foreground)]">
              <strong>P0 稳定层已完成</strong>：审计日志真正写入、actor 上下文、Zod 全量校验、结构化错误体系、Release diff/semver 修复、反馈状态机、store 加固、<strong>268 个测试（95.9% 覆盖率）</strong>；v1.5 再落地评测闭环（trace 落盘 → 沉淀用例 → 发布前 AI 评测）；v1.6 评测升级确定性断言（未过不调判官）与 FAILED 批准须留痕的软门禁；v1.7 新增 MaaS 真实用量聚合与任务证据链视图（只读，非因果证明）。剩余鉴权与 Prisma 落地待后续工程。
            </p>
          </Card>
          <Card>
